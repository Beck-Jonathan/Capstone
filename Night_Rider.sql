...
***************/
print '' Print '***Create the [dbo].[Vendor] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Vendor table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Purchase_Order] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Packing_Slip] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Packing_Slip table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Parts_Inventory] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Parts_Inventory table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Purchase_Order_Line_Item table***' 
go
...
***************/
print '' Print '***Create the [dbo].[Route] table***' 
go
...
***************/
print '' Print '***Insert Sample Data For The  Route table***' 
go
...
***************/
print '' Print '***Create the [dbo].[Stop] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Stop table***' 
 go 
 INSERT INTO [dbo].[Stop] ([Street_Address], [Zip_Code], [Latitude], [Longitude])
VALUES
...
***************/
print '' Print '***Create the [dbo].[Route_Stop] table***' 
go
...
***************/
print '' Print '***Insert Sample Data For The  Route_Stop table***' 
...
***************/
print '' Print '***Create the [dbo].[Vehicle_Type] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Vehicle_Type table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Vehicle] table***' 
 go 
...
CREATE TABLE [dbo].[Vehicle](
    ...
    CONSTRAINT [PK_Vehicle] PRIMARY KEY ([VIN]), 
     CONSTRAINT [AK_VIN] UNIQUE ([VIN]), -- Used ak_... for ones that are 
...
***************/
print '' Print '***Insert Sample Data For The  Vehicle table***' 
 go 

INSERT INTO [dbo].[Vehicle] ([VIN], [Vehicle_Number], [Vehicle_Mileage], [Vehicle_License_Plate]
    , [Vehicle_Type], [Date_Entered], [Rental], [Is_Active])
VALUES 
    ('1HGCM82633A123456', 'VH123', 50000, 'ABC123', 'City Bus', '2024-01-15', 0, 1),
    ('5XYZH4AG4JH123456', 'VH456', 60000, 'XYZ789', 'School Bus', '2024-02-15', 1, 1), 
    ('JM1BK32F781234567', 'VH789', 75000, 'MJK456', 'Van', '2024-03-15', 0, 1), 
    ('WAUZZZ4G6BN123456', 'VH101', 40000, 'WAU789', 'Truck', '2024-04-15', 1, 1), 
    ('1C4RJFAG5FC123456', 'VH202', 55000, 'JFA567', 'City Bus', '2024-05-15', 1, 1); 
GO
...
***************/
print '' Print '***Create the [dbo].[Employee] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Employee_Role] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Employee_Role table***' 
 go 

/******************
Create the [dbo].[Driver_License_Class] table
***************/
print '' Print '***Create the [dbo].[Driver_License_Class] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Driver] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Driver table***' 
 go 
 print '' print '*** Inserting Sample Data for Driver ***'
GO
...
***************/
print '' Print '***Create the [dbo].[Schedule] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Schedule table***' 
 go 
INSERT INTO [dbo].[Schedule] ([Schedule_ID], [Driver_ID],[Week_Days],
...
***************/
print '' Print '***Create the [dbo].[Route_Assignment] table***' 
go
...
***************/
print '' Print '***Insert Sample Data For The  Route_Assignment table***' 
go
...
***************/
print '' Print '***Create the [dbo].[Safety_Report] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Safety_Report table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Refuel_Log] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Refuel_Log table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Service_Type] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service_Type table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Model_Lookup table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Maintenance_Schedule] table***' 
 go 
...
***************/
print '' print '*** maintenance schedule test records ***'
GO
...
***************/
print '' Print '***Create the [dbo].[Service_Line_Item] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Service_Order] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service_Order table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Service_Line] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service_Line table***' 
 go 

/******************
Create the [dbo].[Special_Service_Order] table
***************/
print '' Print '***Create the [dbo].[Special_Service_Order] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Special_Service_Order table***' 
 go
 
  
  INSERT INTO [dbo].[Special_Service_Order] ([Service_Order_ID], [Service_Order_Version],[Event_Description],
                [Priority],[Is_Active]
)
VALUES 
...
***************/
print '' Print '***Create the [dbo].[Special_Inspection] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Special_Inspection table***' 
 go 
 
  INSERT INTO [dbo].[Special_Inspection] ([Special_Service_Order_ID], [Inspection_Description],[Date],
...
***************/
print '' Print '***Create the [dbo].[Bid] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Bid table***' 
 go 
 
 INSERT INTO [dbo].[Bid] ([Special_Service_Order_ID], [vendor_id],[Bid_Description],
...
***************/
print '' Print '***Create the [dbo].[Special_Work_Order] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Special_Work_Order table***' 
 go 
 
  INSERT INTO [dbo].[Special_Work_Order] ([Bid_ID], [Work_Order_Description],[Drop_Off_Date],
...
***************/
print '' Print '***Create the [dbo].[Change_Order] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Change_Order table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Change_Order_Line] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Change_Order_Line table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Packing_Slip_Line_Items] table***' 
go 
...
***************/
print '' Print '***Insert Sample Data For The  Packing_Slip_Line_Items table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Model_Compatibility] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Model_Compatibility table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Service_Detail] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service_Detail table***' 
 go 
INSERT INTO [dbo].[Service_Detail] ([Service_Order_ID],[Service_Order_Version],[Service_Type_ID],[Employee_ID])
VALUES 
...
***************/
print '' Print '***Create the [dbo].[Parts_Request] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Parts_Request table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Parts_Request_Line_Items] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Parts_Request_Line_Items table***' 
 go 
 
 /* Parts Request Line Items Test Record */
print '' print '*** creating parts request line items test records ***'
GO
...
***************/
print '' print '*** Creating Inspection_Report Table ***'
GO
...
***************/
print '' print '*** Inserting Sample Data into Inspection_Report ***'
GO
...
***************/
print '' Print '***Create the [dbo].[Client] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Client table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Client_Credential] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Client_Credential table***' 
 go 
...
***************/
print '' Print '***Creating [dbo].[Login] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Client_Role] table***' 
go 
...
***************/
print '' Print '***Insert Sample Data For The  Client_Role table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Client_Client_Role] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Client_Client_Role table***' 
 go 
GO
...
***************/
print '' Print '***Create the [dbo].[Accommodation] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Accommodation table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Client_Accommodation] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Client_Accommodation table***' 
 go 
...
***************/
print '' Print '***Creating [dbo].[Dependent] table***' 
 go 
...
GO
print '' Print '***Creating Index for [dbo].[Dependent] table***' 
GO
...
***************/
print '' Print '***Create the [dbo].[Client_Dependent_Role] table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Notification] table***' 
 go 
...
GO
print '' Print '***Creating Index for [dbo].[Notification] table***' 
GO
...
***************/
print '' Print '***Insert Sample Data For The  Notification table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Ticket_Type] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Ticket_Type table***' 
 go 
 
  
INSERT INTO [dbo].[Ticket_Type] ([Ticket_Type_ID], [Type_Description])
VALUES
...
***************/
print '' Print '***Create the [dbo].[Support_Ticket] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Support_Ticket table***' 
 go 

/******************
Create the [dbo].[Support_Ticket_Employee_Line] table
***************/
print '' Print '***Create the [dbo].[Support_Ticket_Employee_Line] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Support_Ticket_Employee_Line table***' 
 go 

/******************
Create the [dbo].[Charter] table
***************/
print '' Print '***Create the [dbo].[Charter] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Charter table***' 
 go 

/******************
Create the [dbo].[Charter_Assignment] table
***************/
print '' Print '***Create the [dbo].[Charter_Assignment] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Charter_Assignment table***' 
 go 

/******************
Create the [dbo].[Charter_Accommodation] table
***************/
print '' Print '***Create the [dbo].[Charter_Accommodation] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Charter_Accommodation table***' 
 go 

/******************
Create the [dbo].[Charter_Stop] table
***************/
print '' Print '***Create the [dbo].[Charter_Stop] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Charter_Stop table***' 
 go 

/******************
Create the [dbo].[Charter_Rider] table
***************/
print '' Print '***Create the [dbo].[Charter_Rider] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Charter_Rider table***' 
 go 

/******************
Create the [dbo].[Vehicle_Checklist] table
***************/
print '' Print '***Create the [dbo].[Vehicle_Checklist] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Vehicle_Checklist table***' 
 go 
...
print '' Print '***Insert Sample records for Driver_Maintenance_Report ***' 
...
print '' print '*** Creating Driver_Unavailable table ***'
GO
...
***************/
print '' Print '***Create the [dbo].[Service] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service table***' 
go 
INSERT INTO [dbo].[Service]([Service_ID], [Type])
    VALUES
...
***************/
print '' Print '***Create the [dbo].[Service_Assignment] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Service_Assignment table***' 
 go 
INSERT INTO [dbo].[Service_Assignment] ([VIN], [Service_ID],
...
***************/
print '' Print '***Create the [dbo].[Ride] table***' 
go
...
***************/
print '' Print '***Insert Sample Data For The  Ride table***' 
go
...
***************/
print '' Print '***Create the [dbo].[Source] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Source table***' 
 go 
...
***************/
print '' Print '***Create the [dbo].[Vehicle_Unavailable] table***' 
 go 
...
***************/
print '' Print '***Insert Sample Data For The  Vehicle_Unavailable table***' 
 go 
...
print '' print '*** Creating Vehicle_Driver Table***'
...
***************/
print '' print '*** Inserting Vehicle_Driver Data Sample ***'
GO
INSERT INTO [dbo].[Vehicle_Driver] ([Driver_ID], [VIN], [Date_Assignment_Started], [Date_Assignment_Ended], [Notes], [Is_Active])
VALUES 
