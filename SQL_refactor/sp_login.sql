...
/******************
Create sp_authenticate_employee Stored Procedure
***************/
-- AUTHOR: Jared Hutton
...
/******************
Create sp_authenticate_client_for_security_questions Stored Procedure
***************/
-- AUTHOR: Jared Hutton
...
/******************
Create sp_authenticate_employee_for_security_questions Stored Procedure
***************/
-- AUTHOR: Jared Hutton
...
/******************
Create sp_update_login_password_hash Stored Procedure
***************/
...
/******************
Create sp_get_login_email_by_username Stored Procedure
***************/
-- Initial Creator: Jared Hutton
-- Creation Date: 2024-02-24
-- Last Modified: Jared Hutton
...
/******************
Create sp_get_security_questions_for_username_retrieval Stored Procedure
***************/
-- AUTHOR: Parker Svoboda
print '' print '*** creating sp_get_security_questions_for_username_retrieval ***'
GO
...
/******************
Create sp_get_username Stored Procedure
***************/
-- AUTHOR: Parker Svoboda
print '' print '*** creating sp_get_username ***'
GO
...
AS
  BEGIN
    ...
    WHERE l.[Active] = 1
      AND e.[Is_Active] = 1
      AND e.[Email] = @Email
      AND (l.[Security_Response_1] IS NULL 
        OR l.[Security_Response_1] = @Security_Response_1)
      AND (l.[Security_Response_2] IS NULL 
        OR l.[Security_Response_2] = @Security_Response_2)
      AND (l.[Security_Response_3] IS NULL 
        OR l.[Security_Response_3] = @Security_Response_3)
  END
GO

/******************
Create sp_select_all_client_id_from_login Stored Procedure
***************/
...
print '' print '*** creating sp_select_all_client_id_from_login ***'
GO
...
/******************
Create sp_select_all_employee_id_from_login Stored Procedure
***************/
-- Initial Creator: Jacob Rohr
-- Creation Date: 2024-04-10
-- Modification Description: Initial Creation
-- Stored Procedure Description: Retrieves all Employee ids in a the login table to cross reference elsewhere
print '' print '*** creating sp_select_all_employee_id_from_login ***'
GO
...
/******************
Create sp_get_employee_username_MVC Stored Procedure
***************/
-- Initial Creator: Jacob Rohr
-- Creation Date: 2024-04-10
-- Modification Description: Initial Creation
-- Stored Procedure Description: gets a employee username by email without security questions
print '' print '*** creating sp_get_employee_username_MVC ***'
GO
...
BEGIN
  ...
  FROM [dbo].[Login]
  JOIN [dbo].[Employee] 
    ON [Employee].[Employee_ID] = [Login].[Employee_ID]
  WHERE [Employee].[Email] = @Email
END
GO

/******************
Create sp_get_client_username_MVC Stored Procedure
***************/
-- Initial Creator: Jacob Rohr
-- Creation Date: 2024-04-12
-- Modification Description: Initial Creation
-- Stored Procedure Description: gets a client username by email without security questions
print '' print '*** creating sp_get_client_username_MVC ***'
GO
...
BEGIN
  ...
  FROM [dbo].[Login]
  JOIN [dbo].[Client] 
    ON [Client].[Client_ID] = [Login].[Client_ID]
  WHERE [Client].[Email] = @Email
END
GO

/******************
Create sp_authenticate_client Stored Procedure
***************/
-- Initial Creator: Jacob Rohr
-- Creation Date: 2024-04-12
-- Modification Description: Initial Creation
-- Stored Procedure Description: Ability to authenticate client in the same way as employee
print '' print '*** creating sp_authenticate_client ***'
GO
...
BEGIN
  SELECT
	...
	l.[username]
  FROM [dbo].[Client] c
  JOIN [dbo].[Client_Client_Role] ccr 
    ON c.[Client_ID] = ccr.[Client_ID]
  JOIN [dbo].[Login] l 
...
/******************
Create sp_select_all_usernames Stored Procedure
***************/
...
print '' print '*** creating sp_select_all_usernames ***'
GO
...
/******************
Create sp_insert_employee_login Stored Procedure
***************/
-- Initial Creator: Michael Springer
-- Creation Date: 2024-04-12
-- Last Modified: 
...
print '' print '*** Creating sp_insert_employee_login ***'
GO
