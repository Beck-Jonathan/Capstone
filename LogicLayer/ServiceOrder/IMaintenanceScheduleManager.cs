...
namespace LogicLayer.ServiceOrder
{
    public interface IMaintenanceScheduleManager
    {
        ...
        /// <summary>
        /// Adds a new maintenance schedule to the data
        /// </summary>
        /// <param name="maintenance">The scheduled maintenance to add</param>
        /// <returns>The ID of the newly created maintenance</returns>
        int AddScheduledMaintenance(MaintenanceScheduleVM maintenance);
    }
}
